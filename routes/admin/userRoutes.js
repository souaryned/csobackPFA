...
router.get('/scheduled-with-slots', loggedMiddleware, isManager, getScheduledCandidatesWithSlots);
router.put('/accept/:id', loggedMiddleware, isManager, acceptMembership);
router.get('/manager/choristes', loggedMiddleware,isManager, getChoristesByPupitre);

// ✅ UPDATED: Charter-based bulk acceptance
router.post('/accept-retenu-candidates', loggedMiddleware, isManager, acceptRetenuCandidates);



// Other membership routes
router.put("/refuse/:id", loggedMiddleware, isManager, refuseMembership);
router.get('/available-time-slots', loggedMiddleware, isManager, getAvailableTimeSlots);
router.get('/available-dates', loggedMiddleware, isManager, getAvailableDates);
router.get('/accepted-memberships', loggedMiddleware, isManagerOrChef, getAcceptedMemberships);
